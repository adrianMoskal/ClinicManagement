...
namespace ClinicManagement.Data.Migrations
{
    ...
    [Migration("20220216080252_AddAppointmentsOneToManyRelationshipToAppointmentHours")]
    partial class AddAppointmentsOneToManyRelationshipToAppointmentHours
    {
            ...
            modelBuilder.Entity("ClinicManagement.Entities.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppointmentId = 1,
                            AppointmentHourId = 5,
                            Date = new DateTime(2022, 2, 11, 9, 2, 52, 412, DateTimeKind.Local).AddTicks(1081),
                        ...
                        new
                        {
                            AppointmentId = 2,
                            AppointmentHourId = 2,
                            Date = new DateTime(2022, 2, 13, 9, 2, 52, 413, DateTimeKind.Local).AddTicks(3300),
                            DoctorId = "6ca24cbc-8085-475b-8bee-b3c09575561e",
                            PatientId = "cc033eab-8a7e-4c70-8a87-1aee071141a4"
                        },
                        new
                        {
                            AppointmentId = 3,
                            AppointmentHourId = 7,
                            Date = new DateTime(2022, 2, 15, 9, 2, 52, 413, DateTimeKind.Local).AddTicks(3321),
